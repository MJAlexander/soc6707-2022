...
- As for the EDA, in order to aid presentation and for ease of reading, it is suggested that you 'hide' the code that produces any graphs when knitting the Rmd. You can do this by adding `echo = FALSE` to the top of the R chunk. This will just knit the output of the code, rather than the code itself. 
